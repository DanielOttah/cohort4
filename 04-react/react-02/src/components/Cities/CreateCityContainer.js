    ...
    render() {
        ...
        return (
            <div id={`city_${this.props.name}`}>
                ...
                <Button className="accordion" name={this.props.name} onClick={this.props.onClick} />
                <div className="panel1" id={this.props.name}>
                    <p className="low_top_margin">Native Country Name: {this.props.allAPICityArray[this.props.index].NativeName}</p>
                    <p className="low_top_margin">Country of City: {this.props.allAPICityArray[this.props.index].CountryName}</p>
                    <p className="low_top_margin">Country Demonym: {this.props.allAPICityArray[this.props.index].Demonym}</p>
                    <p className="low_top_margin">Calling Code: {this.props.allAPICityArray[this.props.index].CallingCodes}</p>
                    <p className="low_top_margin">Region: {this.props.allAPICityArray[this.props.index].Region}</p>
                    <p className="low_top_margin">Sub-Region: {this.props.allAPICityArray[this.props.index].Subregion}</p>
                    <p className="low_top_margin">Time-Zone: {this.props.allAPICityArray[this.props.index].TimeZone}</p>
                    <p className="low_top_margin">Population: {this.props.allAPICityArray[this.props.index].Population}</p>
                    <p className="low_top_margin">Location: {`${this.props.allAPICityArray[this.props.index].Location[0]}° | ${this.props.allAPICityArray[this.props.index].Location[1]}°`}</p>
                    <p className="low_top_margin">Land Area: {this.props.allAPICityArray[this.props.index].Area}</p>
                    <p className="low_top_margin">Border: {`${boarder} ${cntry_boarders[cntry_boarders.length - 1]}`}</p>
                    ...
                    <hr />
                    <Button name={"Delete City"} id={`delete${this.props.allAPICityArray[this.props.index].capital}`} onClick={this.props.onClickAPIDelete} style={{ marginRight: "2px 0px 0px 0px" }} />
                    <Button name={"Learn More"} onClick={this.handleLearnClick} />
                </div>
            </div>
        );
